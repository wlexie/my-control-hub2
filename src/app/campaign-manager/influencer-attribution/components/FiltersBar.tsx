...
export default function FiltersBar() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl space-y-4">
      <h2 className="text-black font-semibold text-lg">Filters</h2>
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative flex-1 min-w-[180px]">
          <select
            ...
            className="w-full h-12 px-3 pl-9 pr-8 text-sm border rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
          >
        ...
        <div className="relative flex-1 min-w-[150px]">
          <input
            ...
            className="w-full h-12 px-3 pr-9 text-sm border rounded-lg bg-gray-100 cursor-pointer focus:outline-none"
          />
        ...
        <div className="relative flex-1 min-w-[160px]">
          <select
            ...
            className="w-full h-12 px-3 pl-9 pr-8 text-sm border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
          >
            <option value="">Code Type</option>
            <option value="one-time">One-time Use</option>
            <option value="campaign">Total Campaign</option>
        ...
        <div className="flex items-center gap-2 ml-auto">
          <button className="h-12 px-5 text-sm rounded-lg bg-blue-600 text-white hover:bg-blue-700">
            Apply Filter
          </button>
          <button
            onClick={handleClear}
            className="h-12 px-5 text-sm rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200"
          >
            Clear all
          </button>
        </div>
